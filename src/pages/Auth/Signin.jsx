      ...
      <div className="relative min-h-screen sm:flex sm:flex-row justify-center bg-transparent rounded-3xl shadow-xl">
        <div className="flex-col flex self-center lg:px-14 sm:max-w-4xl xl:max-w-md z-10">
          <div className="self-start hidden lg:flex flex-col  text-gray-300">
            <Logo width={100} />
            <h1 className="my-3 font-semibold text-4xl mt-5">Welcome back</h1>
            {/* <p className="pr-3 text-sm opacity-75 mt-5">
          ...
          <div className="p-12 bg-white mx-auto rounded-3xl w-96 shadow-lg">
            ...
            <div className="space-y-6">
              ...
              <div>
                <button
                  type="submit"
                  className="w-full flex justify-center bg-indigo-700  hover:bg-indigo-600 text-gray-100 p-3  rounded-lg tracking-wide font-semibold  cursor-pointer transition ease-in duration-500"
                >
                  Sign in
                </button>
              </div>
              ...
              <div className="flex justify-center gap-5 w-full ">
                ...
                >
                  <img src={GoogleIcon} className="w-5 h-5 mr-5" />
                  <span>Google</span>
                </button>
              </div>
            </div>
